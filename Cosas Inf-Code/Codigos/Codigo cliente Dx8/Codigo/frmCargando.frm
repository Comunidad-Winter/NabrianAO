...
Function Analizar()
           ...
           FormLauncher.Label1.Caption = "SERVIDOR: Buscando Actualizaciones..."
            Dim iX As Integer
            Dim tX As Integer
            Dim DifX As Integer
           
'LINK1            'Variable que contiene el numero de actualización correcto del servidor
                iX = Inet1.OpenURL("http://nabrianupd.ddns.net/aup/VEREXE.txt")
            'Variable que contiene el numero de actualización del cliente
              tX = LeerInt(App.Path & "\INIT\Update.ini")
               DifX = iX - tX
 
     If Not (DifX = 0) Then
FormLauncher.Label1.Caption = "SERVIDOR: Se encontraron " & DifX & " Actualizaciones."
...
End
Else
FormLauncher.Image1.Visible = True
FormLauncher.Image3.Visible = False
FormLauncher.Label1.Caption = "SERVIDOR: No se han descargado actualizaciones."
End If
...
FormLauncher.Image1.Visible = True
FormLauncher.Image3.Visible = False
FormLauncher.Label1.Caption = "SERVIDOR: No se han encontrado actualizaciones."
End If
End Function
