...
'Con.ConnectionString = "DRIVER={MySQL ODBC 3.51 Driver};SERVER=localhost; DATABASE=nabrianao;UID=nabrianao;PWD=lsao666; OPTION=3"
Con.ConnectionString = "DRIVER={MySQL ODBC 3.51 Driver};" & "SERVER=localhost;" & " DATABASE=nabrianao;" & "UID=root;PWD=asd123; OPTION=3"
...
str = str & ",CanjesDonador=" & mUser.flags.CanjesDonador '"
str = str & ",Advertencias=" & mUser.flags.Advertencias '"
str = str & ",RetosGanados=" & mUser.flags.RetosGanados '"
str = str & ",RetosPErdidos=" & mUser.flags.RetosPerdidos '"
str = str & ",Canje=" & mUser.flags.yaledio '"
str = str & ",Canje=" & mUser.flags.PremioUserLevel46 '"
str = str & ",Canje=" & mUser.flags.PremioUserLevel47 '"
str = str & ",Canje=" & mUser.flags.PremioUserLevel48 '"
str = str & ",Canje=" & mUser.flags.PremioUserLevel49 '"
str = str & ",Canje=" & mUser.flags.PremioUserLevel50 '"
str = str & ",SuCodigo=" & mUser.flags.SuCodigo '"
...
str = str & ",LastHD=" & UserList(Userindex).HDDisck & "'"
str = str & ",Mother=" & UserList(Userindex).MotherNumber & "'"
...
With UserList(Userindex)
    ...
    .flags.CanjesDonador = RS!CanjesDonador
    .flags.Advertencias = RS!Advertencias
    .flags.RetosGanados = RS!RetosGanados
    .flags.RetosPerdidos = RS!RetosPerdidos
    .flags.yaledio = RS!yaledio
    .flags.PremioUserLevel50 = RS!PremioUserLevel46
    .flags.PremioUserLevel50 = RS!PremioUserLevel47
    .flags.PremioUserLevel50 = RS!PremioUserLevel48
    .flags.PremioUserLevel50 = RS!PremioUserLevel49
    .flags.PremioUserLevel50 = RS!PremioUserLevel50
    .flags.SuCodigo = RS!SuCodigo
