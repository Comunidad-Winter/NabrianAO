Attribute VB_Name = "mod_Compressor"
Option Explicit
'Public Formato As String * 6
Public Const Formato As String * 6 = "NABRIAN"
Public Const PasswordPak As Long = 568921
...
On Local Error GoTo ErrHandler
    Select Case file_type
        Case Graphics
            ...
            OutputFilePath = "GRAFICOS\Graficos.NABRIAN"
        Case MP3
            SourceFilePath = App.Path & "\" & resource_path & "\"
            SourceFileExtension = ".mp3"
            OutputFilePath = "MP3\MP3.NABRIAN"
        Case WAV
            SourceFilePath = App.Path & "\" & resource_path & "\"
            SourceFileExtension = ".WAV"
            OutputFilePath = "WAV\WAV.NABRIAN"
    End Select
    ...
    '************ Write Data
    FileHead.lngFileSize = FileHead.lngFileSize + PasswordPak 'Lorwik > Aqui ponemos que en el textbox va la pass
    ...
    Select Case file_type
        Case Graphics
            ...
            Else
                SourceFilePath = resource_path & "\Graficos." & Formato
            End If
            OutputFilePath = App.Path & "\graficos\"
        ...
        Case MP3
                SourceFilePath = resource_path & "\MP3." & Formato
            OutputFilePath = App.Path & "\mp3\"
        
        Case WAV
            SourceFilePath = resource_path & "\WAV." & Formato
            OutputFilePath = App.Path & "\Recursos\"
...
Public Function Extract_File_Memory(ByVal file_type As resource_file_type, ByVal File_Name As String, ByRef SourceData() As Byte) As Boolean
