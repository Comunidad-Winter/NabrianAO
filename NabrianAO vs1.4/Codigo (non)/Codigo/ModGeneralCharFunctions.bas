...
If MapData(X, Y).Graphic(1).GrhIndex >= 1505 And _
   ...
   MapData(X, Y).Graphic(2).GrhIndex = 0 Or _
   MapData(X, Y).Graphic(1).GrhIndex >= 21982 And _
   MapData(X, Y).Graphic(1).GrhIndex <= 21997 And _
   MapData(X, Y).Graphic(2).GrhIndex = 0 Or _
   MapData(X, Y).Graphic(1).GrhIndex >= 21966 And _
   MapData(X, Y).Graphic(1).GrhIndex <= 21981 And _
