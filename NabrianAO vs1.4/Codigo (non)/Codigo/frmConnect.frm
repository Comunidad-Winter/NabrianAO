...
Call SwitchMapNew(RandomNumber(500, 501)) 'renderizamo conectar
UserMinHP = 1 'conectar renderizado pa que se vea a color
EngineRun = False


Call Audio.StopMidi
Dim EsmusicaRandom As Integer
EsmusicaRandom = RandomNumber(1, 2)
If EsmusicaRandom = 1 Then
Call Audio.PlayWave(1, "intro")
ElseIf EsmusicaRandom = 2 Then
Call Audio.PlayWave(1, "3")
End If
...
Call Audio.PlayWave(0, SND_CLICK)
Call ShellExecute(Me.hwnd, "open", "http://nabrianao.com/foro", "", "", 1)
End Sub
