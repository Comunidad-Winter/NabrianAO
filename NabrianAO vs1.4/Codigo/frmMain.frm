...
Begin VB.Form frmPrincipal 
   ...
   Begin VB.Frame frHechizos 
      ...
      Begin VB.ListBox lstHechizos 
         ...
         ForeColor       =   &H00FFFFFF&
         Height          =   2370
         ItemData        =   "frmMain.frx":3178C
         Left            =   240
         List            =   "frmMain.frx":31793
         TabIndex        =   95
         Top             =   600
         Width           =   2650
      End
   ...
   Begin VB.Image ImgMen 
      ...
      Height          =   330
      Left            =   10530
      MouseIcon       =   "frmMain.frx":3CF1F
      MousePointer    =   99  'Custom
      Picture         =   "frmMain.frx":3DBE9
      Top             =   5925
      Visible         =   0   'False
      Width           =   330
   End
...
Call AddtoRichTextBox(frmPrincipal.rectxt, "Esto indica cuanto daño tiene el arma que llevas equipada.", 255, 255, 255, 0, 0)
End Sub
...
Call AddtoRichTextBox(frmPrincipal.rectxt, "Tips> Recuerda que puedes donar y conseguir puntos e ítems únicos en el servidor ingresando a la siguiente pagina web: https://sites.google.com/site/manualnabrianao/items-de-canjeo-y-donador", 255, 51, 255, 0, 0)
...
Call AddtoRichTextBox(frmPrincipal.rectxt, "Tips> Te invitamos a leer el reglamento del juego para una mejor estadía https://sites.google.com/site/manualnabrianao/reglamento-del-juego", 255, 255, 255, 0, 0)
...
Call AddtoRichTextBox(frmPrincipal.rectxt, "Tips> ¿Aún no conoces el privilegio de templarios en estas tierras? Intenta conseguirlo es todo un reto pero un mayor privilegio: https://sites.google.com/site/manualnabrianao/templario", 255, 255, 255, 0, 0)
ElseIf MensajeRandom = 7 Then
Call AddtoRichTextBox(frmPrincipal.rectxt, "Tips> ¿Estas buscando algún Npc y no lo encuentras? Visita este link puede ayudarte: https://sites.google.com/site/manualnabrianao/mapa-drop-y-ubicaciones-de-npc-s", 153, 255, 255, 0, 0)
ElseIf MensajeRandom = 8 Then
Call AddtoRichTextBox(frmPrincipal.rectxt, "Beneficio> Te recordamos que si das Me Gusta a nuestra página de facebook consigues 5 puntos de canjeo (Donador) por cada like que consigas con una cuenta activa. ¿Como lo hago?: http://nabrianao.com/foro/index.php?threads/beneficio-facebook.17/", 255, 51, 255, 0, 0)
End If
End Sub
...
If Index = 1 Then
Call AddtoRichTextBox(frmPrincipal.rectxt, "Recuerda tener una buena reputación ya que esto deriva a tu ranking en el top de 250 usuarios del juego: http://nabrianao.com/ranking.php", 255, 255, 255, 0, 0)
ElseIf Index = 2 Then
Call AddtoRichTextBox(frmPrincipal.rectxt, "Activando esta opción probaras una nueva forma de tirar Hechizos marcando el intervalo correcto del juego, en caso de que prefieras la clásica solo desactiva esta opción.", 255, 255, 255, 0, 0)
End If
End Sub
...
If SeguridadActiva = True Then
IPdelServidor = "127.0.0.1" ' ACA LA IP ON
Else
...
frmPrincipal.Picture = LoadPicture(App.Path & "\Graficos\Principal0.jpg")
frmPrincipal.imgFondoInvent.Picture = LoadPicture(App.Path & "\Graficos\Centronuevoinventario0.jpg")
frmPrincipal.imgFondoHechizos.Picture = LoadPicture(App.Path & "\Graficos\Centronuevohechizos0.jpg")
ElseIf SkinGrafico = 1 Then
frmPrincipal.Picture = LoadPicture(App.Path & "\Graficos\Principal1.jpg")
frmPrincipal.imgFondoInvent.Picture = LoadPicture(App.Path & "\Graficos\Centronuevoinventario1.jpg")
frmPrincipal.imgFondoHechizos.Picture = LoadPicture(App.Path & "\Graficos\Centronuevohechizos1.jpg")
ElseIf SkinGrafico = 2 Then
frmPrincipal.Picture = LoadPicture(App.Path & "\Graficos\Principal3.jpg")
frmPrincipal.imgFondoInvent.Picture = LoadPicture(App.Path & "\Graficos\Centronuevoinventario3.jpg")
frmPrincipal.imgFondoHechizos.Picture = LoadPicture(App.Path & "\Graficos\Centronuevohechizos3.jpg")
ElseIf SkinGrafico = 3 Then
frmPrincipal.Picture = LoadPicture(App.Path & "\Graficos\Principal2.jpg")
frmPrincipal.imgFondoInvent.Picture = LoadPicture(App.Path & "\Graficos\Centronuevoinventario2.jpg")
frmPrincipal.imgFondoHechizos.Picture = LoadPicture(App.Path & "\Graficos\Centronuevohechizos2.jpg")
End If
...
Call AddtoRichTextBox(frmPrincipal.rectxt, "Usa esto para guiarte en el mapa que estas en este momento, esto es un dibujado del mapa el punto rojo es la posición donde estas tu parado.", 192, 192, 192, 0, 0)
End Sub
