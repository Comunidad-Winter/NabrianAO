...
Set oMail = New clsCDOmail
    ...
    With oMail
        ...
        .De = "NabrianAO staff"
        .Para = UserMail
        .Mensaje = "Estimado usuario, le informamos que el personaje " & UserNick & " tiene nueva contraseña. Ésta nueva password fué solicitada desde el juego para su recuperación. La nueva contraseña es " & ObtenerPassword(UserNick) & ".Rogamos memoizarla o cambiarla. Atte. NabrianAO Staff."
