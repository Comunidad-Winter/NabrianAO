...
Begin VB.Form frmOptimizar 
   ...
   Begin VB.CheckBox CheckBloqTrala 
      Caption         =   "Quitar Bloqueos de los traslados"
      Height          =   255
      Left            =   120
      TabIndex        =   8
      Top             =   2640
...
For Y = YMinMapSize To YMaxMapSize
    For X = XMinMapSize To XMaxMapSize
        ...
        End If
        '** Quitar bloqueos de traslados
         If MapData(X, Y).TileExit.Map > 0 Then
         If MapData(X, Y).Blocked = 1 And CheckBloqTrala.value = 1 Then ' quita bloq de traslados
